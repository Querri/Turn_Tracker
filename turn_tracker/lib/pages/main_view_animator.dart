...
class AnimatedStart extends StatefulWidget {
  AnimatedStart({Key key, this.isReady, this.shouldAnimateReady, this.buttonSize}) : super(key: key);
  final bool isReady;
...
class _AnimatedStartState extends State<AnimatedStart> with TickerProviderStateMixin {
